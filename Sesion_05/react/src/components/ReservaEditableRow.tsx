// ============================================================================
// ReservaEditableRow — fila editable de la tabla de reservas
// ============================================================================
// Hijo de AdminBookingsPage. Encapsula el flujo de edición inline: el botón
// "Editar" activa un modo de edición donde las celdas de fecha se convierten
// en <input type="date">, y el botón cambia a "Guardar". Al guardar, valida
// el nuevo rango (utils/businessLogic) y solo entonces notifica al padre,
// quien persiste el cambio y marca la reserva como "reprogramada".
...
export interface ReservaEditableRowProps {
  ...
  onCancelar: () => void;
  onGuardarReprogramacion: (nuevaFechaInicio: string, nuevaFechaFin: string) => Promise<void> | void;
}

export function ReservaEditableRow({
  reserva,
  nombreHabitacion,
  nombreUsuario,
  cancelando,
