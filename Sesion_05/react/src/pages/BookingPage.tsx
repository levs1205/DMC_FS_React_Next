...
export function BookingPage() {
  ...
  async function handleReservar() {
    if (!habitacionSeleccionada || !disponible || !usuario) return;
    ...
    try {
      // Se guarda en el mismo arreglo mockeado que lista AdminBookingsPage.
    ...
    <section className="booking-page">
      <header className="booking-page__header">
        ...
        <div className="booking-page__user">
          ...
          <button type="button" className="booking-page__logout" onClick={cerrarSesion}>
            Cerrar sesión
          </button>
        </div>
      </header>
      ...
      {habitacionSeleccionada && fechasValidas && (
        <div className="booking-page__result">
          ...
          <button
            ...
            disabled={!disponible || creandoReserva}
            onClick={handleReservar}
          >
            {creandoReserva ? 'Reservando...' : 'Reservar'}
          </button>
        </div>
      )}
